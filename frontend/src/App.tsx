          ...
          >
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <img
                  src="/src/assets/images/nad_supplement_bottle_1782904203422.jpg"
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              <div className="pt-4 border-t border-neutral-200">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-neutral-500 font-mono font-bold">
                  ...
                  <span className="px-2.5 py-1 bg-white border border-neutral-200 rounded">APPLE PAY</span>
                  <span className="px-2.5 py-1 bg-white border border-neutral-200 rounded">PAYPAL</span>
                </div>
              </div>
